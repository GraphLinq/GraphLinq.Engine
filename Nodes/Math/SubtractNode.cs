...
{
    [NodeDefinition("SubtractNode", "Substract A - B", NodeTypeEnum.Function, "Math")]
    [NodeGraphDescription("Calculate the substraction of value of A - B (both sent in params) and return it as out parameter.")]
    public class SubtractNode : Node
    {
        public SubtractNode(string id, BlockGraph graph)
            : base(id, graph, typeof(SubtractNode).Name)
        {
