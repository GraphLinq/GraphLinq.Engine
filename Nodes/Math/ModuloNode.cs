...
{
    [NodeDefinition("ModuloNode", "Modulo A % B", NodeTypeEnum.Function, "Math")]
    [NodeGraphDescription("Calculate the Modulo of value of A % B (both sent in params) and return it as out parameter.")]
    public class ModuloNode : Node
    {
        public ModuloNode(string id, BlockGraph graph)
                    : base(id, graph, typeof(ModuloNode).Name)
        {
